...
export function AdminTableRow({ row, type, selected, onSelectRow, onDeleteRow, onRestoreRow, onEditRow, onTrashRow }: AdminTableRowProps) {
            ...
            <TableRow hover tabIndex={-1} role="checkbox" selected={selected}>
                ...
                <TableCell component="th" scope="row">
                    <Box gap={2} display="flex" alignItems="center">
                        ...
                        <a onClick={() => router.push(`/admin/${row._id}/edit`)} style={{ cursor: 'pointer' }}>
                            {row.name}
                        </a>
                    </Box>
                </TableCell>
